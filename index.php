...
<head>
    ...
    <title>Online Bookstore - Code Camp BD</title>
    <!-- Bootstrap -->
                  ...
                  <div id="login" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header"  style="background: #2c2c2c;">
                            ...
                            <div class="modal-body">
                                          <form class="form" role="form" method="post" action="index.php" accept-charset="UTF-8">
                                              ...
                                              <div class="form-group">
                                                  <button type="submit"  style="background: #2c2c2c;" name="submit" value="login" class="btn btn-block">
                                                      Sign in 
                                                  </button>
                                              </div>
                                          </form>
                            ...
                            <div class="modal-footer">
                                <button type="button"  style="background: #2c2c2c;" class="btn btn-default" data-dismiss="modal">Close</button>
                            </div>
                        </div>
                    </div>
                  </div>
                      ...
                      <div class="modal-content">
                          ...
                          <div class="modal-body">
                                        <form class="form" role="form" method="post" action="index.php" accept-charset="UTF-8">
                                            ...
                                            <div class="form-group">
                                                <button type="submit"  style="background: #2c2c2c;" name="submit" value="register" class="btn btn-block">
                                                    Sign Up
                                                </button>
                                            </div>
                                        </form>
...
?>
      ...
      <div class="container-fluid" id="header">
          <div class="row">
              <div class="col-md-3 col-lg-3" id="category">
                  <div style="background:#f7f7f7;color:black;font-weight:800;border:none;padding:15px;">Book Catagory </div>
                  <ul>
  ...
  <div class="container-fluid" id="author">
    ...
    <div class="row">
               <a href="description.php?ID=ENT-5">
                <div class="col-sm-6 col-md-3 col-lg-3 text-center">
                    <div class="book-block" style="border :3px solid #DEEAEE;">
                        <img class="book block-center img-responsive" src="img/books/ENT-5.jpg">
                        <hr>
                         IIM Indore IPM Full Length Test Series (Fully Solved)<br>
                        599  &nbsp;
                        <span style="text-decoration:line-through;color:#828282;"> 740 </span>
                        <span class="label label-warning">19%</span>
                    </div>
                </div>
                
               </a> 
               <a href="description.php?ID=ENT-6">
                <div class="col-sm-6 col-md-3 col-lg-3 text-center">
                    <div class="book-block" style="border :3px solid #DEEAEE;">
                        <img class="book block-center img-responsive" src="img/books/ENT-6.jpg">
                        <hr>
                         Marketing Management<br>
                        802  &nbsp;
                        <span style="text-decoration:line-through;color:#828282;"> 899 </span>
                        <span class="label label-warning">11%</span>
                    </div>
                </div>
                
               </a> 
               <a href="description.php?ID=ENT-7">
                <div class="col-sm-6 col-md-3 col-lg-3 text-center">
                    <div class="book-block" style="border :3px solid #DEEAEE;">
                        <img class="book block-center img-responsive" src="img/books/ENT-7.jpg">
                        <hr>
                         The Mega Yearbook 2016 - Current Affairs &amp; General Knowledge For Competitive Exams<br>
                        175  &nbsp;
               ...
               <a href="description.php?ID=ENT-8">
                <div class="col-sm-6 col-md-3 col-lg-3 text-center">
                    <div class="book-block" style="border :3px solid #DEEAEE;">
                        <img class="book block-center img-responsive" src="img/books/ENT-8.jpg">
                        <hr>
                         Indian Polity (Civil Services Mains; Csat; Civil Services General)<br>
                        595  &nbsp;
                        <span style="text-decoration:line-through;color:#828282;"> 425 </span>
                        <span class="label label-warning">29%</span>
                    </div>
                </div>
              ...
              <div class="col-sm-7 col-md-5 col-lg-5">
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-6 text-center">
                          ...
                          <p>developer.mhrony@gmail.com</p>
                      </div>
                  </div>
              </div>
